...
let progress1 = setInterval(() => {
  ...
  progressBar1.style.background = `conic-gradient(var(--yellow) ${progressStartValue1 * 3.6}deg, #ededed 0deg)`;
...
let progress2 = setInterval(() => {
  ...
  progressBar2.style.background = `conic-gradient(var(--yellow) ${progressStartValue2 * 3.6}deg, #ededed 0deg)`;
...
let progress3 = setInterval(() => {
  ...
  progressBar3.style.background = `conic-gradient(var(--yellow) ${progressStartValue3 * 3.6}deg, #ededed 0deg)`;
...
let progress4 = setInterval(() => {
  ...
  progressBar4.style.background = `conic-gradient(var(--yellow) ${progressStartValue4 * 3.6}deg, #ededed 0deg)`;
